...
<p align="center">
  <img src="./playwright-config.svg" alt="playwright-config logo" width="128" />
</p>

<h1 align="center">@sebastienrousseau/playwright-config</h1>

<p align="center">
  Shareable Playwright configuration rules for cross-browser E2E testing and parallel execution.
</p>

<p align="center">
  <a href="https://github.com/sebastienrousseau/playwright-config/actions"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/playwright-config/ci.yml?branch=main&style=for-the-badge&logo=github" alt="Build Status" /></a>
  <a href="https://www.npmjs.com/package/@sebastienrousseau/playwright-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fplaywright-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/playwright-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  <a href="https://scorecard.dev/viewer/?uri=github.com/sebastienrousseau/playwright-config"><img src="https://img.shields.io/ossf-scorecard/github.com/sebastienrousseau/playwright-config?style=for-the-badge&label=OpenSSF%20Scorecard&logo=openssf" alt="OpenSSF Scorecard" /></a>
  <a href="https://www.bestpractices.dev/projects/14515"><img src="https://img.shields.io/cii/level/14515?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Cross-Browser E2E Testing Settings](#cross-browser-e2e-testing-settings) — before and after rule comparison
...
Install `@sebastienrousseau/playwright-config` as a development dependency:
...
Merge the shared options into your Playwright config.

### playwright.config.js

```js
import { defineConfig } from "@playwright/test";
import shared from "@sebastienrousseau/playwright-config";
...
`@sebastienrousseau/playwright-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/playwright-config` solves this with three deliberate engineering choices:
...
## Cross-Browser E2E Testing Settings

Pre-configured for Chromium, Firefox, and WebKit browsers, HTML reporters, trace retention, and parallel runs.
...
### After (@sebastienrousseau/playwright-config Enforced)
...
When running integration tests exclusively via Cypress or Selenium WebDriver runners.
