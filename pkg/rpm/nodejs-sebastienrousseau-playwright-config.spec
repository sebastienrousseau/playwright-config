...
%global npm_bare      playwright-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-playwright-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Playwright configuration rules for cross-browser E2E testing and parallel execution

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/playwright-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/playwright-config is a shareable configuration preset with no runtime
...
install -pm 0644 playwright.config.js %{buildroot}%{sitelib}/%{npm_scope}/%{npm_bare}/
