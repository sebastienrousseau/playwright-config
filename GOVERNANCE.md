...
This document describes how @sebastienrousseau/playwright-config is run: who decides what, how
...
@sebastienrousseau/playwright-config is **maintainer-led**. As of the current release line it has a single
